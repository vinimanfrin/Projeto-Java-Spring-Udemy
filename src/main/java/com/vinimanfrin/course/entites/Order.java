package com.vinimanfrin.course.entites;

import com.fasterxml.jackson.annotation.JsonFormat;
import com.vinimanfrin.course.enums.OrderStatus;
...
public class Order implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name = "client_id") //na tabela de pedidos do banco de dados , terei uma chave estrangeira chamada client id , nela conterá o id do usuario associado
    private User client;
